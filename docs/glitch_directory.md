...
This repo contains everything you need to get started building a Microsoft Teams bot with [Botkit](https://botkit.ai) and [Botkit Studio](https://botkit.ai).
...
* A sample "note taker" app that weaves together bot features, as well as:
  * A Botkit Studio scripts to import
...
#### Set up your Microsoft Teams Application
Once you have remixed this project, the next thing you will want to do is set up a new Microsoft Teams application. This is a multi-step process, but only takes a few minutes.

[Read this step-by-step guide](https://github.com/howdyai/botkit/blob/master/docs/provisioning/teams.md) to make sure everything is set up.
...
Once successfully logged in, your bot will connect to Microsoft Teams AND Botkit Studio and leap into action!
